...
public class FCMService {
    ...
    public void sendMessage(Map<String, String> data, PushNotificationRequest request)
        ...
        logger.info(
            "Sent message with data. Topic: " + request.getTopic() + ", " + response + " msg "
                + jsonOutput);
    }
    ...
    private AndroidConfig getAndroidConfig(String topic) {
        return AndroidConfig.builder().setTtl(Duration.ofMinutes(2).toMillis())
            .setCollapseKey(topic).setPriority(AndroidConfig.Priority.HIGH).setNotification(
    ...
    private Message.Builder getPreconfiguredMessageBuilder(PushNotificationRequest request) {
        ...
        final Notification notification = Notification.builder().setTitle(request.getTitle())
